// mock-data.js — static mock account-status data (demo only — all personal details are
// fictional). Derivation logic lives in domain.js; row generators in txn-utils.js.
import { minusDays } from './dates.js';
import { synthRows } from './txn-utils.js';
...
export {
  ...
  WORKLIST, STATUS, CASE_TIMELINE, TASKS, TASK_TYPES, CLERKS, CURRENT_CLERK, HOLDER_EXTRA,
};
