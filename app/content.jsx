...
import { fmt, QUICK_ACTIONS } from './data.jsx';
...
import { SubjectStrip } from './subject-strip.jsx';
import { chargeRows, chargeBalance, buildEntityRows } from './entity-helpers.js';
import { PropertyTypesModal, HoldersHistoryModal } from './entity-modals.jsx';
        ...
        <td key="holder" style={{ padding: cellPad, textAlign: "center" }}>
          <button onClick={e => { e.stopPropagation(); if (hasH) setHoldersModal(entity); }}
            ...
            {isMine ? <span style={{ fontSize: 16, color: "var(--ok-fg)", fontWeight: 800, lineHeight: 1 }}>✓</span>
              : <Icon name="history" size={14} color="var(--teal-600)"/>}
          </button>
        </td>);},
    bal:    (entity, i, isOpen) => {
